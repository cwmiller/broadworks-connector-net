...
namespace BroadWorksConnector
{
    public static class OCISchemaServiceInCallServiceActivationExtensions
    {
        ...
        /// Request the service provider's DTMF based in-call service activation trigger attributes.The response is either a ServiceProviderInCallServiceActivationGetResponse17 or an ErrorResponse.
        /// </summary>
        public static async Task<ServiceProviderInCallServiceActivationGetResponse17> ServiceProviderInCallServiceActivationGetRequest17Async(this OcipClient client, ServiceProviderInCallServiceActivationGetRequest17 request, CancellationToken cancellationToken = default)
        {
        ...
        /// Modifies the service provider's DTMF based in-call service activation trigger attributes.The response is either a SuccessResponse or an ErrorResponse.
        /// </summary>
        public static async Task<SuccessResponse> ServiceProviderInCallServiceActivationModifyRequest17Async(this OcipClient client, ServiceProviderInCallServiceActivationModifyRequest17 request, CancellationToken cancellationToken = default)
        {
        ...
        /// Request the system's DTMF based in-call service activation trigger attributes. The response is either a SystemInCallServiceActivationGetResponse17 or an ErrorResponse.
        /// </summary>
        public static async Task<SystemInCallServiceActivationGetResponse17> SystemInCallServiceActivationGetRequest17Async(this OcipClient client, SystemInCallServiceActivationGetRequest17 request, CancellationToken cancellationToken = default)
        {
        ...
        /// Modifies the system's DTMF based in-call service activation trigger  attributes.The response is either a SuccessResponse or an ErrorResponse.
        /// </summary>
        public static async Task<SuccessResponse> SystemInCallServiceActivationModifyRequest17Async(this OcipClient client, SystemInCallServiceActivationModifyRequest17 request, CancellationToken cancellationToken = default)
        {
            return await client.CallAsync(request, cancellationToken).ConfigureAwait(false) as SuccessResponse;
        }
        /// <summary>
        ...
        /// ErrorResponse.
        /// </summary>
        public static async Task<UserInCallServiceActivationGetResponse> UserInCallServiceActivationGetRequestAsync(this OcipClient client, UserInCallServiceActivationGetRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// The response is either a SuccessResponse or an ErrorResponse.
        /// </summary>
        public static async Task<SuccessResponse> UserInCallServiceActivationModifyRequestAsync(this OcipClient client, UserInCallServiceActivationModifyRequest request, CancellationToken cancellationToken = default)
        {
            return await client.CallAsync(request, cancellationToken).ConfigureAwait(false) as SuccessResponse;
        }
