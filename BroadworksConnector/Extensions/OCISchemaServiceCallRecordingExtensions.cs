...
namespace BroadWorksConnector
{
    public static class OCISchemaServiceCallRecordingExtensions
    {
        ...
        {
            return await client.Call(request) as GroupCallRecordingGetResponse;
        }
        ...
        {
            return await client.Call(request) as SystemCallRecordingGetPlatformListResponse22V2;
        }
        ...
        {
            return await client.Call(request) as SystemCallRecordingGetPlatformUsageResponse22;
        }
        ...
        {
            return await client.Call(request) as SystemCallRecordingGetResponse22;
        }
        ...
        {
            return await client.Call(request) as SystemCallRecordingGetResponse23;
        }
        ...
        {
            return await client.Call(request) as UserCallRecordingGetResponse20;
        }
