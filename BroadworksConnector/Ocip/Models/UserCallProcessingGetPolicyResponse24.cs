...
{
    /// <summary>
    /// Response to UserCallProcessingGetPolicyRequest24.
    ...
    /// <see cref="UserCallProcessingGetPolicyRequest24"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""fb73488c2ef4ac4400ab213b637d79a9:1009""}]")]
    public class UserCallProcessingGetPolicyResponse24 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useUserCLIDSetting;

        [XmlElement(ElementName = "useUserCLIDSetting", IsNullable = false, Namespace = "")]
        [Group(@"fb73488c2ef4ac4400ab213b637d79a9:1009")]
        ...
        public bool AllowUserSelectionOfExternalCLIDPolicy
        {
            ...
            set
            {
                AllowUserSelectionOfExternalCLIDPolicySpecified = true;
        ...
        public bool AllowUserConfigurableCLIDModification
        {
            ...
            set
            {
                AllowUserConfigurableCLIDModificationSpecified = true;
