...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="ServiceProviderAccessDeviceGetRequest22V3"/>
    /// <see cref="ServiceProviderAccessDeviceGetResponse24"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""de4d76f01f337fe4694212ec9f771753:4881""}]")]
    public class ServiceProviderAccessDeviceGetResponse22V3 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"de4d76f01f337fe4694212ec9f771753:4881")]
        [MinLength(1)]
        [MaxLength(40)]
