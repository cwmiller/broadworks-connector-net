...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupCallProcessingGetPolicyResponse17sp3"/>
    /// <see cref="ErrorResponse"/>
    /// <see cref="GroupCallProcessingGetPolicyRequest17sp4"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:7845""}]")]
    public class GroupCallProcessingGetPolicyRequest17sp3 : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupCallProcessingGetPolicyResponse17sp3>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:7845")]
        [MinLength(1)]
        [MaxLength(30)]
