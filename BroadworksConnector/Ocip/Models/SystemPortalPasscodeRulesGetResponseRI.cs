...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// 
    /// Note: For the element defaultPassword, type Password is used for backward compatibility
    /// although the modify command uses type Passcode.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:15032""}]")]
    public class SystemPortalPasscodeRulesGetResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _disallowRepeatedDigits;

        [XmlElement(ElementName = "disallowRepeatedDigits", IsNullable = false, Namespace = "")]
        [Group(@"da582a1f8028404e70d260cf1f891033:15032")]
