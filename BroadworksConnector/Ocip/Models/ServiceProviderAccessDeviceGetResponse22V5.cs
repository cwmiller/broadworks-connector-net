...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="ServiceProviderAccessDeviceGetRequest22V4"/>
    /// <see cref="ServiceProviderAccessDeviceGetResponse24V2"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:5669""}]")]
    public class ServiceProviderAccessDeviceGetResponse22V5 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:5669")]
        [MinLength(1)]
        [MaxLength(40)]
