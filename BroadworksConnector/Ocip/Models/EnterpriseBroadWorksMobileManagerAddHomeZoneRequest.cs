...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    public class EnterpriseBroadWorksMobileManagerAddHomeZoneRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {
