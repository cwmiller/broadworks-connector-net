...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// Replaced by: SystemDeviceTypeGetResponse22V13 in XS data mode.
    /// Replaced by: SystemDeviceTypeGetResponse22V6 in AS data mode.
    /// <see cref="SystemSIPDeviceTypeGetRequest22V5"/>
    /// <see cref="SystemDeviceTypeGetResponse22V13"/>
    /// <see cref="SystemDeviceTypeGetResponse22V6"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:34510""}]")]
    public class SystemSIPDeviceTypeGetResponse22V5 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _isObsolete;

        [XmlElement(ElementName = "isObsolete", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:34510")]
        ...
        protected BroadWorksConnector.Ocip.Models.CPEDeviceOptionsRead22V2 _cpeDeviceOptions;
