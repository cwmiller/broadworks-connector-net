...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// or an ErrorResponse.
    /// <see cref="GroupOfficeZoneGetAssignedUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""f3a93cf15de4abd7903673e44ee3e07b:6730""}]")]
    public class GroupOfficeZoneGetAssignedUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupOfficeZoneGetAssignedUserListResponse>
    {

        private string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"f3a93cf15de4abd7903673e44ee3e07b:6730")]
        [MinLength(1)]
        [MaxLength(30)]
