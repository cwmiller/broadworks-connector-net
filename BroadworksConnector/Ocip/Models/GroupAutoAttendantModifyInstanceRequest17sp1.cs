...
public  class GroupAutoAttendantModifyInstanceRequest17sp1 : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    public BroadworksConnector.Ocip.Models.AutoAttendantModifyMenu16 BusinessHoursMenu { get; set; }
    [XmlElement(ElementName = "afterHoursMenu", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.AutoAttendantModifyMenu16 AfterHoursMenu { get; set; }
    [XmlElement(ElementName = "holidayMenu", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.AutoAttendantModifyMenu16 HolidayMenu { get; set; }
