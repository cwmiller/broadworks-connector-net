...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="SystemCallProcessingPolicyProfileFindMeFollowMeProfileGetRequest"/>
    /// <see cref="SystemCallProcessingPolicyProfileFindMeFollowMeProfileGetResponse22"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ab0042aa512abc10edb3c55e4b416b0b:22735""}]")]
    public class SystemCallProcessingPolicyProfileFindMeFollowMeProfileGetResponse : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        private bool _useCLIDPolicy;

        [XmlElement(ElementName = "useCLIDPolicy", IsNullable = false, Namespace = "")]
        [Group(@"ab0042aa512abc10edb3c55e4b416b0b:22735")]
