...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// Replaced by: GroupMusicOnHoldModifyInstanceRequestRIV2.
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:4192""}]")]
    public class GroupMusicOnHoldModifyInstanceRequestRI : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:4192")]
        [MinLength(1)]
        [MaxLength(30)]
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceModifyRI _source;

        [XmlElement(ElementName = "source", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"240b50f54d060859e5e275082fdf49f9:4192")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceModifyRI Source
        {
            get => _source;
            set
            {
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceModifyRI _internalSource;

        [XmlElement(ElementName = "internalSource", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"240b50f54d060859e5e275082fdf49f9:4192")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceModifyRI InternalSource
        {
            get => _internalSource;
            set
            {
