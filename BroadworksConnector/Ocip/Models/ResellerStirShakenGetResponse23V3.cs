...
{
    /// <summary>
    /// Response to the ResellerStirShakenGetRequest23V3.
    /// Replaced by ResellerStirShakenGetResponse23V4.
    /// <see cref="ResellerStirShakenGetRequest23V3"/>
    /// <see cref="ResellerStirShakenGetResponse23V4"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:19058""}]")]
    public class ResellerStirShakenGetResponse23V3 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useParentLevelSettings;

        [XmlElement(ElementName = "useParentLevelSettings", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:19058")]
