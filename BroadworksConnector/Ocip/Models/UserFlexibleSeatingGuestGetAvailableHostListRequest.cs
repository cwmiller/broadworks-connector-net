...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="UserFlexibleSeatingGuestGetAvailableUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""1d4e390f8cd01ca6f92589024d74dac6:367""}]")]
    public class UserFlexibleSeatingGuestGetAvailableHostListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.UserFlexibleSeatingGuestGetAvailableHostListResponse>
    {
        ...
        [Group(@"1d4e390f8cd01ca6f92589024d74dac6:367")]
        [MinLength(1)]
        [MaxLength(161)]
