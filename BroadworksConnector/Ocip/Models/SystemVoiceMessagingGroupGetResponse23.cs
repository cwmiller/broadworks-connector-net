...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// vmBucketName
    /// 
    /// The following elements are no longer used in AS data mode:
    /// storageSelection, value "Mail Server" is returned in both AS and XS data mode
    /// <see cref="SystemVoiceMessagingGroupGetRequest23"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:17899""}]")]
    public class SystemVoiceMessagingGroupGetResponse23 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _realDeleteForImap;

        [XmlElement(ElementName = "realDeleteForImap", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:17899")]
        ...
        public string VmBucketName
        {
            ...
            set
            {
                VmBucketNameSpecified = (value != null);
                _vmBucketName = value;
            }
        }
        ...
        public bool SelectMwiTemplatePerCaller
        {
            ...
            set
            {
                SelectMwiTemplatePerCallerSpecified = true;
