...
{
    /// <summary>
    /// Response to the UserBroadWorksAnywhereGetSelectiveCriteriaRequestRI.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""f39163d0e42e05c4a1692a62f625df9f:539""}]")]
    public class UserBroadWorksAnywhereGetSelectiveCriteriaResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Optional]
        [Group(@"f39163d0e42e05c4a1692a62f625df9f:539")]
