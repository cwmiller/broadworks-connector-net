...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""1b5ee40628a3f2b1bcab94a53dec91e7:457""}]")]
    public class ExtendedMixedCallLogsEntry23
    {
        ...
        [Group(@"1b5ee40628a3f2b1bcab94a53dec91e7:457")]
        ...
        protected BroadWorksConnector.Ocip.Models.ServiceInvocationDisposition23? _serviceInvocationDisposition;

        [XmlElement(ElementName = "serviceInvocationDisposition", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"1b5ee40628a3f2b1bcab94a53dec91e7:457")]
        public BroadWorksConnector.Ocip.Models.ServiceInvocationDisposition23? ServiceInvocationDisposition
        {
        ...
        public string DirectRouteNumber
        {
            ...
            set
            {
                DirectRouteNumberSpecified = (value != null);
        ...
        public string RouteListDN
        {
            ...
            set
            {
                RouteListDNSpecified = (value != null);
                _routeListDN = value;
            }
        }
