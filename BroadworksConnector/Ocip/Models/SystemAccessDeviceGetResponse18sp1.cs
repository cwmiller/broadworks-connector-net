...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="SystemAccessDeviceGetRequest18sp1"/>
    /// <see cref="SystemAccessDeviceGetResponse22"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:7695""}]")]
    public class SystemAccessDeviceGetResponse18sp1 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:7695")]
        [MinLength(1)]
        [MaxLength(40)]
