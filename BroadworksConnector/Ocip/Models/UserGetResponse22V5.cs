...
public  class UserGetResponse22V5 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public BroadworksConnector.Ocip.Models.AccessDeviceMultipleIdentityAndContactEndpointRead22 AccessDeviceEndpoint { get; set; }
    [XmlElement(ElementName = "trunkAddressing", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.TrunkAddressingMultipleContactRead22 TrunkAddressing { get; set; }
