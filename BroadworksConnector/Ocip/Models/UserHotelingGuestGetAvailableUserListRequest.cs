...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="UserHotelingGuestGetAvailableUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""b3a47d1de480374e33d6efb9aa2bd2d0:46""}]")]
    public class UserHotelingGuestGetAvailableUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.UserHotelingGuestGetAvailableUserListResponse>
    {

        protected string _userId;

        [XmlElement(ElementName = "userId", IsNullable = false, Namespace = "")]
        [Group(@"b3a47d1de480374e33d6efb9aa2bd2d0:46")]
        [MinLength(1)]
        [MaxLength(161)]
