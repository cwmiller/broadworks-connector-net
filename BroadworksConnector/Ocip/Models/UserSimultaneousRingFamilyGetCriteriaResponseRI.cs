...
{
    /// <summary>
    /// Response to the UserSimultaneousRingFamilyGetCriteriaRequestRI.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""7829cd70c5c6e02768e0a59a5de29efe:105""}]")]
    public class UserSimultaneousRingFamilyGetCriteriaResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Optional]
        [Group(@"7829cd70c5c6e02768e0a59a5de29efe:105")]
