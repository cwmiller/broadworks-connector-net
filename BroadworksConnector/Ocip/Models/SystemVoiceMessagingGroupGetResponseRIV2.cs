...
{
    /// <summary>
    /// Response to SystemVoiceMessagingGroupGetRequestRIV2.
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:18031""}]")]
    public class SystemVoiceMessagingGroupGetResponseRIV2 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _realDeleteForImap;

        [XmlElement(ElementName = "realDeleteForImap", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:18031")]
