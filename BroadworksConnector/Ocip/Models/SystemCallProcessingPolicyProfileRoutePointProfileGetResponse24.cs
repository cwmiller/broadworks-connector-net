...
{
    /// <summary>
    /// Response to SystemCallProcessingPolicyProfileRoutePointProfileGetRequest24.
    ...
    /// <see cref="SystemCallProcessingPolicyProfileRoutePointProfileGetRequest24"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:4651""}]")]
    public class SystemCallProcessingPolicyProfileRoutePointProfileGetResponse24 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useCLIDPolicy;

        [XmlElement(ElementName = "useCLIDPolicy", IsNullable = false, Namespace = "")]
        [Group(@"da582a1f8028404e70d260cf1f891033:4651")]
