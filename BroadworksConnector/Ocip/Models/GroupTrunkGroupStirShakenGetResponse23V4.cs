...
{
    /// <summary>
    /// Response to the GroupTrunkGroupStirShakenGetRequest23V4.
    /// <see cref="GroupTrunkGroupStirShakenGetRequest23V4"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""4b0e7857796c636464362260a2f8e5ee:8387""}]")]
    public class GroupTrunkGroupStirShakenGetResponse23V4 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useParentLevelSettings;

        [XmlElement(ElementName = "useParentLevelSettings", IsNullable = false, Namespace = "")]
        [Group(@"4b0e7857796c636464362260a2f8e5ee:8387")]
