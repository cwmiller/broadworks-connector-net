...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupUserCallingPlanSettingsGetListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""4b0e7857796c636464362260a2f8e5ee:8400"",""children"":[{""__type"":""Choice:#BroadWorksConnector.Ocip.Validation"",""id"":""4b0e7857796c636464362260a2f8e5ee:8405""}]}]")]
    public class GroupUserCallingPlanSettingsGetListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupUserCallingPlanSettingsGetListResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"4b0e7857796c636464362260a2f8e5ee:8400")]
        [MinLength(1)]
        [MaxLength(30)]
        ...
        protected BroadWorksConnector.Ocip.Models.CallingPlanService _callingPlanService;

        [XmlElement(ElementName = "callingPlanService", IsNullable = false, Namespace = "")]
        [Group(@"4b0e7857796c636464362260a2f8e5ee:8400")]
        public BroadWorksConnector.Ocip.Models.CallingPlanService CallingPlanService
        {
            get => _callingPlanService;
            set
            {
                CallingPlanServiceSpecified = true;
                _callingPlanService = value;
            }
        }

        [XmlIgnore]
        protected bool CallingPlanServiceSpecified { get; set; }
        ...
        [Group(@"4b0e7857796c636464362260a2f8e5ee:8405")]
