...
{
    /// <summary>
    /// Response to ServiceProviderAdminGetPolicyRequestRI.
    ...
    /// passwordRulesAccess, value "Full" is returned in XS mode
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""e19a9072c2dad499e9f28837da5768db:1547""}]")]
    public class ServiceProviderAdminGetPolicyResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Group(@"e19a9072c2dad499e9f28837da5768db:1547")]
        ...
        public BroadWorksConnector.Ocip.Models.ServiceProviderAdminPasswordRulesAccess PasswordRulesAccess
        {
            ...
            set
            {
                PasswordRulesAccessSpecified = true;
