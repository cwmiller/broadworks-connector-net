...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:27711""}]")]
    public class SystemHolidayScheduleModifyRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _holidayScheduleName;

        [XmlElement(ElementName = "holidayScheduleName", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:27711")]
        [MinLength(1)]
        [MaxLength(40)]
        ...
        protected string _newHolidayScheduleName;
        ...
        public string NewHolidayScheduleName
        {
            ...
            set
            {
                NewHolidayScheduleNameSpecified = (value != null);
                _newHolidayScheduleName = value;
            }
        }

        [XmlIgnore]
        protected bool NewHolidayScheduleNameSpecified { get; set; }
