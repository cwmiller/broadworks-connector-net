...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// callMeNowRule
    /// 
    /// Replaced by: SystemCommunicationBarringProfileGetResponse19sp1 in AS data mode
    /// <see cref="SystemCommunicationBarringProfileGetRequest17sp3"/>
    /// <see cref="SystemCommunicationBarringProfileGetResponse19sp1"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:10327""}]")]
    public class SystemCommunicationBarringProfileGetResponse17sp3 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Optional]
        [Group(@"240b50f54d060859e5e275082fdf49f9:10327")]
        [MinLength(1)]
        [MaxLength(80)]
        ...
        public int? CallMeNowDefaultCallTimeout
        {
            ...
            set
            {
                CallMeNowDefaultCallTimeoutSpecified = (value != null);
        ...
        public List<BroadWorksConnector.Ocip.Models.CommunicationBarringCallMeNowRule> CallMeNowRule
        {
            ...
            set
            {
                CallMeNowRuleSpecified = (value != null);
