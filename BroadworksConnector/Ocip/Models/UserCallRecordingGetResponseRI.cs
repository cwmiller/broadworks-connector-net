...
{
    /// <summary>
    /// Response to the UserCallRecordingGetRequestRI.
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""0731150ec7515df8cd710f04d8f62f66:371""}]")]
    public class UserCallRecordingGetResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Group(@"0731150ec7515df8cd710f04d8f62f66:371")]
