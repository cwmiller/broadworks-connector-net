...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// ErrorResponse.
    /// <see cref="GroupAccessDeviceGetLinkedTreeDeviceResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""f3a93cf15de4abd7903673e44ee3e07b:918""}]")]
    public class GroupAccessDeviceGetLinkedTreeDeviceRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupAccessDeviceGetLinkedTreeDeviceResponse>
    {

        private string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"f3a93cf15de4abd7903673e44ee3e07b:918")]
        [MinLength(1)]
        [MaxLength(30)]
