...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="UserSelectiveCallRejectionGetResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""b3553d7704f59ff8de2f730be450316f:94""}]")]
    public class UserSelectiveCallRejectionGetCriteriaListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.UserSelectiveCallRejectionGetCriteriaListResponse>
    {
        ...
        [Group(@"b3553d7704f59ff8de2f730be450316f:94")]
        [MinLength(1)]
        [MaxLength(161)]
