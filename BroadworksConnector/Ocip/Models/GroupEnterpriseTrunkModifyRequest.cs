...
public  class GroupEnterpriseTrunkModifyRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    public BroadworksConnector.Ocip.Models.GroupEnterpriseTrunkModifyRequestOrderedRouting OrderedRouting { get; set; }
    [XmlElement(ElementName = "priorityWeightedRouting", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.GroupEnterpriseTrunkModifyRequestPriorityWeightedRouting PriorityWeightedRouting { get; set; }
