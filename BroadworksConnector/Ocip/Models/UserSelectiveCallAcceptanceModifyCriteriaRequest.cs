...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// 
    /// Replaced by: UserSelectiveCallAcceptanceModifyCriteriaRequestRI in AS data mode
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:21497""}]")]
    public class UserSelectiveCallAcceptanceModifyCriteriaRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _userId;

        [XmlElement(ElementName = "userId", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:21497")]
        [MinLength(1)]
        [MaxLength(161)]
