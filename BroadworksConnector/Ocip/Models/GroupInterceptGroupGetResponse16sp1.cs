...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// Replaced By: GroupInterceptGroupGetRequestRI in XS mode
    /// <see cref="GroupInterceptGroupGetRequest16sp1"/>
    /// <see cref="GroupInterceptGroupGetResponse21sp1"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:12079""}]")]
    public class GroupInterceptGroupGetResponse16sp1 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _isActive;

        [XmlElement(ElementName = "isActive", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:12079")]
        ...
        public string OutboundReroutePhoneNumber
        {
            ...
            set
            {
                OutboundReroutePhoneNumberSpecified = (value != null);
