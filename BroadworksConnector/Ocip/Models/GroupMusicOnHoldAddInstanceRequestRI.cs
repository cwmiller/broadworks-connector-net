...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""3a0309eb8d406fefc891f554ef114669:55""}]")]
    public class GroupMusicOnHoldAddInstanceRequestRI : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"3a0309eb8d406fefc891f554ef114669:55")]
        [MinLength(1)]
        [MaxLength(30)]
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceAddRI _source;

        [XmlElement(ElementName = "source", IsNullable = false, Namespace = "")]
        [Group(@"3a0309eb8d406fefc891f554ef114669:55")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceAddRI Source
        {
            get => _source;
            set
            {
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceAddRI _internalSource;

        [XmlElement(ElementName = "internalSource", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"3a0309eb8d406fefc891f554ef114669:55")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceAddRI InternalSource
        {
            get => _internalSource;
            set
            {
