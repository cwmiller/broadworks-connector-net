...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupSeriesCompletionGetAvailableUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""5fb5b7b7662e17019e762f6db743dda1:89""}]")]
    public class GroupSeriesCompletionGetAvailableUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupSeriesCompletionGetAvailableUserListResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"5fb5b7b7662e17019e762f6db743dda1:89")]
        [MinLength(1)]
        [MaxLength(30)]
