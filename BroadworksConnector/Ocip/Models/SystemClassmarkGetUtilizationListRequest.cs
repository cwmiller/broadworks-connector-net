...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="SystemClassmarkGetUtilizationListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""bd23272215266344f26a1702c47ce590:115""}]")]
    public class SystemClassmarkGetUtilizationListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.SystemClassmarkGetUtilizationListResponse>
    {
        ...
        [Group(@"bd23272215266344f26a1702c47ce590:115")]
        [MinLength(1)]
        [MaxLength(40)]
        ...
        protected BroadWorksConnector.Ocip.Models.SearchCriteriaExactServiceProvider _searchCriteriaExactServiceProviderId;
        ...
        public BroadWorksConnector.Ocip.Models.SearchCriteriaExactServiceProvider SearchCriteriaExactServiceProviderId
        {
            ...
            set
            {
                SearchCriteriaExactServiceProviderIdSpecified = (value != null);
                _searchCriteriaExactServiceProviderId = value;
            }
        }

        [XmlIgnore]
        protected bool SearchCriteriaExactServiceProviderIdSpecified { get; set; }
