...
public  class SystemClassmarkGetUtilizationListRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "searchCriteriaExactServiceProviderId", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.SearchCriteriaExactServiceProvider SearchCriteriaExactServiceProviderId { get; set; }
