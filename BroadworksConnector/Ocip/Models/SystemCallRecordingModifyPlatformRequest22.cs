...
public  class SystemCallRecordingModifyPlatformRequest22 : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "becomeSystemDefault", IsNullable = false)]
    public bool BecomeSystemDefault { get; set; }
    [XmlElement(ElementName = "becomeResellerDefault", IsNullable = false)]
    public string BecomeResellerDefault { get; set; }
    ...
    [XmlElement(ElementName = "route", IsNullable = true)]
