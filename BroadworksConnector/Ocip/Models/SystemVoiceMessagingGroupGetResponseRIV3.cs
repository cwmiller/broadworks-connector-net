...
{
    /// <summary>
    /// Response to SystemVoiceMessagingGroupGetRequestRIV3.
    /// 
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""1fea1222b6a78aa7b98fd5c41bdae113:633""}]")]
    public class SystemVoiceMessagingGroupGetResponseRIV3 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _realDeleteForImap;

        [XmlElement(ElementName = "realDeleteForImap", IsNullable = false, Namespace = "")]
        [Group(@"1fea1222b6a78aa7b98fd5c41bdae113:633")]
        ...
        public bool AlwaysSendSIPNotify
        {
            ...
            set
            {
                AlwaysSendSIPNotifySpecified = true;
        ...
        public bool AlwaysSendPushNotification
        {
            ...
            set
            {
                AlwaysSendPushNotificationSpecified = true;
