...
{
    /// <summary>
    /// Response to the GroupStirShakenGetRequest23V3.
    /// Replaced by GroupStirShakenGetResponse23V4.
    /// <see cref="GroupStirShakenGetRequest23V3"/>
    /// <see cref="GroupStirShakenGetResponse23V4"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:14912""}]")]
    public class GroupStirShakenGetResponse23V3 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useParentLevelSettings;

        [XmlElement(ElementName = "useParentLevelSettings", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:14912")]
