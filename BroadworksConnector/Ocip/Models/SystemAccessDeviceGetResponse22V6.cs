...
{
    /// <summary>
    /// Response to SystemAccessDeviceGetRequest22V6
    ...
    /// authBearerSubject
    /// 
    /// Replaced by: SystemAccessDeviceGetResponse24V3
    /// <see cref="SystemAccessDeviceGetRequest22V6"/>
    /// <see cref="SystemAccessDeviceGetResponse24V3"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:7979""}]")]
    public class SystemAccessDeviceGetResponse22V6 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:7979")]
        [MinLength(1)]
        [MaxLength(40)]
