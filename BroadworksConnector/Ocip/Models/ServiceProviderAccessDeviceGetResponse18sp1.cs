...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="ServiceProviderAccessDeviceGetRequest18sp1"/>
    /// <see cref="ServiceProviderAccessDeviceGetResponse22"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:5437""}]")]
    public class ServiceProviderAccessDeviceGetResponse18sp1 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:5437")]
        [MinLength(1)]
        [MaxLength(40)]
