...
{
    /// <summary>
    /// Response to the SystemStirShakenGetRequest23V5.
    /// <see cref="SystemStirShakenGetRequest23V5"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:18397""}]")]
    public class SystemStirShakenGetResponse23V5 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Group(@"da582a1f8028404e70d260cf1f891033:18397")]
        ...
        public BroadWorksConnector.Ocip.Models.StirShakenApiCompatibility ApiCompatibility
        {
            ...
            set
            {
                ApiCompatibilitySpecified = true;
        ...
        public BroadWorksConnector.Ocip.Models.StirShakenIdentityHeadersHandling IdentityHeadersHandlingForRedirectedCalls
        {
            ...
            set
            {
                IdentityHeadersHandlingForRedirectedCallsSpecified = true;
        ...
        public bool EnableVerificationForRedirectedCalls
        {
            ...
            set
            {
                EnableVerificationForRedirectedCallsSpecified = true;
