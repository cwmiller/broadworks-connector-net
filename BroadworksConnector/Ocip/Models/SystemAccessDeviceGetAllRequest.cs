...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:1082""}]")]
    public class SystemAccessDeviceGetAllRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.SystemAccessDeviceGetAllResponse>
    {
        ...
        [Optional]
        [Group(@"da582a1f8028404e70d260cf1f891033:1082")]
        [MinInclusive(1)]
        ...
        protected BroadWorksConnector.Ocip.Models.SearchCriteriaExactDeviceServiceProvider _searchCriteriaExactDeviceServiceProvider;
        ...
        public BroadWorksConnector.Ocip.Models.SearchCriteriaExactDeviceServiceProvider SearchCriteriaExactDeviceServiceProvider
        {
            ...
            set
            {
                SearchCriteriaExactDeviceServiceProviderSpecified = (value != null);
                _searchCriteriaExactDeviceServiceProvider = value;
            }
        }

        [XmlIgnore]
        protected bool SearchCriteriaExactDeviceServiceProviderSpecified { get; set; }
