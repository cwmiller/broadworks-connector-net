...
public  class GroupAutoAttendantGetInstanceResponse14 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public BroadworksConnector.Ocip.Models.AutoAttendantReadMenu BusinessHoursMenu { get; set; }
    [XmlElement(ElementName = "afterHoursMenu", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.AutoAttendantReadMenu AfterHoursMenu { get; set; }
 }
}
