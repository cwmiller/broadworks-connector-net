...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:3675""}]")]
    public class GroupMusicOnHoldGetInstanceResponse19 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _serviceUserId;

        [XmlElement(ElementName = "serviceUserId", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3675")]
        [MinLength(1)]
        [MaxLength(161)]
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead19 _source;

        [XmlElement(ElementName = "source", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3675")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead19 Source
        {
            get => _source;
            set
            {
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead19 _internalSource;

        [XmlElement(ElementName = "internalSource", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3675")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead19 InternalSource
        {
            get => _internalSource;
            set
            {
