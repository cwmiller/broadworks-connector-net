...
public  class GroupHuntGroupConsolidatedModifyInstanceRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "agentWeightList", IsNullable = true)]
    public BroadworksConnector.Ocip.Models.ReplacementAgentWeightList AgentWeightList { get; set; }
    ...
    [XmlElement(ElementName = "serviceList", IsNullable = true)]
    public BroadworksConnector.Ocip.Models.ReplacementConsolidatedUserServiceAssignmentList ServiceList { get; set; }
    [XmlElement(ElementName = "isActive", IsNullable = false)]
    public bool IsActive { get; set; }
    [XmlElement(ElementName = "directoryNumberHuntingAgentUserIdList", IsNullable = true)]
    public BroadworksConnector.Ocip.Models.ReplacementUserIdList DirectoryNumberHuntingAgentUserIdList { get; set; }
