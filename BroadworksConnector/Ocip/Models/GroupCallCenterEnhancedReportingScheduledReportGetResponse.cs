...
public  class GroupCallCenterEnhancedReportingScheduledReportGetResponse : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public BroadworksConnector.Ocip.Models.CallCenterScheduledReportAgentSelectionAdminRead Agent { get; set; }
    [XmlElement(ElementName = "callCenter", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.CallCenterScheduledReportCallCenterSelectionRead CallCenter { get; set; }
    [XmlElement(ElementName = "dnis", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.CallCenterScheduledReportDNISSelectionRead Dnis { get; set; }
