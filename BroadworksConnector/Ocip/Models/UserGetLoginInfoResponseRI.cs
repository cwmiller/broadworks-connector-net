...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ef3c4f453d01f7ce750331de83ebc765:563""}]")]
    public class UserGetLoginInfoResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Group(@"ef3c4f453d01f7ce750331de83ebc765:563")]
        ...
        public string TokenRevocationTime
        {
            ...
            set
            {
                TokenRevocationTimeSpecified = (value != null);
        ...
        protected int? _lockoutPeriodExpiry;

        [XmlElement(ElementName = "lockoutPeriodExpiry", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"ef3c4f453d01f7ce750331de83ebc765:563")]
        public int? LockoutPeriodExpiry
        {
            get => _lockoutPeriodExpiry;
            set
            {
                LockoutPeriodExpirySpecified = (value != null);
                _lockoutPeriodExpiry = value;
            }
        }

        [XmlIgnore]
        protected bool LockoutPeriodExpirySpecified { get; set; }
