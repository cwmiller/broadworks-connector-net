...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// useDeviceCode
    /// 
    /// Replaced by GroupAccessDeviceGetResponse24V2.
    /// <see cref="GroupAccessDeviceGetRequest22V4"/>
    /// <see cref="GroupAccessDeviceGetResponse24V2"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:1010""}]")]
    public class GroupAccessDeviceGetResponse22V4 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:1010")]
        [MinLength(1)]
        [MaxLength(40)]
