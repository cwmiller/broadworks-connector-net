...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// ErrorResponse.
    /// Replaced by:
    /// GroupCallCenterOverflowModifyRequest20 in AS mode
    /// GroupCallCenterOverflowModifyRequestXS in XS mode.
    /// <see cref="SuccessResponse"/>
    /// <see cref="ErrorResponse"/>
    /// <see cref="GroupCallCenterOverflowModifyRequest20"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:7907""}]")]
    public class GroupCallCenterOverflowModifyRequest17 : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _serviceUserId;

        [XmlElement(ElementName = "serviceUserId", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:7907")]
        [MinLength(1)]
        [MaxLength(161)]
        ...
        public bool? OverflowAfterTimeout
        {
            ...
            set
            {
                OverflowAfterTimeoutSpecified = (value != null);
        ...
        public bool? PlayAnnouncementBeforeOverflowProcessing
        {
            ...
            set
            {
                PlayAnnouncementBeforeOverflowProcessingSpecified = (value != null);
