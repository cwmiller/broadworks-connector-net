...
{
    /// <summary>
    /// Response to the GroupCallCenterGetDNISAnnouncementRequestRI.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""4d65d3449061c568639c8cc1e2492285:4352""}]")]
    public class GroupCallCenterGetDNISAnnouncementResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _playEntranceMessage;

        [XmlElement(ElementName = "playEntranceMessage", IsNullable = false, Namespace = "")]
        [Group(@"4d65d3449061c568639c8cc1e2492285:4352")]
