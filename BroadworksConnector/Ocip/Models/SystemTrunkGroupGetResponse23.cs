...
[Serializable]
[XmlRoot(Namespace = "")]
public  class SystemTrunkGroupGetResponse23 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    [XmlElement(ElementName = "allowPAILookupForOutOfDialogPBXRedirection", IsNullable = false)]
    public bool AllowPAILookupForOutOfDialogPBXRedirection { get; set; }
    [XmlElement(ElementName = "outOfDialogPBXRedirectionOriginatorLookupPolicy", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.TrunkGroupOutOfDialogPBXRedirectionOriginatorLookupPolicy OutOfDialogPBXRedirectionOriginatorLookupPolicy { get; set; }
    [XmlElement(ElementName = "allowTrunkIdentityForAllOriginations", IsNullable = false)]
    public bool AllowTrunkIdentityForAllOriginations { get; set; }
 }
}
