...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// routeOverrideDomain
    /// routeOverridePrefix
    /// <see cref="SystemCallProcessingGetPolicyRequest24V2"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:3103""}]")]
    public class SystemCallProcessingGetPolicyResponse24V2 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useMaxSimultaneousCalls;

        [XmlElement(ElementName = "useMaxSimultaneousCalls", IsNullable = false, Namespace = "")]
        [Group(@"da582a1f8028404e70d260cf1f891033:3103")]
        ...
        protected bool _forceTreatmentOnMaximumRedirectionDepth;

        [XmlElement(ElementName = "forceTreatmentOnMaximumRedirectionDepth", IsNullable = false, Namespace = "")]
        [Group(@"da582a1f8028404e70d260cf1f891033:3103")]
        public bool ForceTreatmentOnMaximumRedirectionDepth
        {
            get => _forceTreatmentOnMaximumRedirectionDepth;
            set
            {
                ForceTreatmentOnMaximumRedirectionDepthSpecified = true;
                _forceTreatmentOnMaximumRedirectionDepth = value;
            }
        }

        [XmlIgnore]
        protected bool ForceTreatmentOnMaximumRedirectionDepthSpecified { get; set; }

        protected bool _enableUserSelectionOfExternalCLIDPolicy;

        [XmlElement(ElementName = "enableUserSelectionOfExternalCLIDPolicy", IsNullable = false, Namespace = "")]
        [Group(@"da582a1f8028404e70d260cf1f891033:3103")]
        public bool EnableUserSelectionOfExternalCLIDPolicy
        {
            get => _enableUserSelectionOfExternalCLIDPolicy;
            set
            {
                EnableUserSelectionOfExternalCLIDPolicySpecified = true;
                _enableUserSelectionOfExternalCLIDPolicy = value;
            }
        }

        [XmlIgnore]
        protected bool EnableUserSelectionOfExternalCLIDPolicySpecified { get; set; }

        protected bool _enableUserConfigurableCLIDModification;

        [XmlElement(ElementName = "enableUserConfigurableCLIDModification", IsNullable = false, Namespace = "")]
        [Group(@"da582a1f8028404e70d260cf1f891033:3103")]
        public bool EnableUserConfigurableCLIDModification
        {
            get => _enableUserConfigurableCLIDModification;
            set
            {
                EnableUserConfigurableCLIDModificationSpecified = true;
                _enableUserConfigurableCLIDModification = value;
            }
        }

        [XmlIgnore]
        protected bool EnableUserConfigurableCLIDModificationSpecified { get; set; }
