...
public  class UserPhoneDirectoryGetListRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "includeCommonPhoneList", IsNullable = false)]
    public bool IncludeCommonPhoneList { get; set; }
    ...
    [XmlElement(ElementName = "searchCriteriaExactCustomContactDirectory", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.SearchCriteriaExactCustomContactDirectory SearchCriteriaExactCustomContactDirectory { get; set; }
