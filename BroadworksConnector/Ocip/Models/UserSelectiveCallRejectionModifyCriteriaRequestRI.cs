...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""b3553d7704f59ff8de2f730be450316f:200""}]")]
    public class UserSelectiveCallRejectionModifyCriteriaRequestRI : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _userId;

        [XmlElement(ElementName = "userId", IsNullable = false, Namespace = "")]
        [Group(@"b3553d7704f59ff8de2f730be450316f:200")]
        [MinLength(1)]
        [MaxLength(161)]
        ...
        protected BroadWorksConnector.Ocip.Models.SelectiveCallRejectionCriteriaCallTypeModifyRI _fromDnCriteria;

        [XmlElement(ElementName = "fromDnCriteria", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"b3553d7704f59ff8de2f730be450316f:200")]
        public BroadWorksConnector.Ocip.Models.SelectiveCallRejectionCriteriaCallTypeModifyRI FromDnCriteria
        {
            get => _fromDnCriteria;
            set
            {
