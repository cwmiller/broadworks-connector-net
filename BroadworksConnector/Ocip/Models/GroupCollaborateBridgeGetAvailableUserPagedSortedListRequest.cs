...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupCollaborateBridgeGetAvailableUserPagedSortedListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""bc805893b9cc7e3e01eec64e9ad62768:258""}]")]
    public class GroupCollaborateBridgeGetAvailableUserPagedSortedListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupCollaborateBridgeGetAvailableUserPagedSortedListResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"bc805893b9cc7e3e01eec64e9ad62768:258")]
        [MinLength(1)]
        [MaxLength(30)]
        ...
        protected List<BroadWorksConnector.Ocip.Models.SortOrderGroupCollaborateBridgeGetAvailableUserPagedSortedList> _sortOrder = new List<BroadWorksConnector.Ocip.Models.SortOrderGroupCollaborateBridgeGetAvailableUserPagedSortedList>();

        [XmlElement(ElementName = "sortOrder", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"bc805893b9cc7e3e01eec64e9ad62768:258")]
        public List<BroadWorksConnector.Ocip.Models.SortOrderGroupCollaborateBridgeGetAvailableUserPagedSortedList> SortOrder
        {
            get => _sortOrder;
            set
            {
