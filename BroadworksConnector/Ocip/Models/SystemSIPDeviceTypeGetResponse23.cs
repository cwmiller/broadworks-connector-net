...
[Serializable]
[XmlRoot(Namespace = "")]
public  class SystemSIPDeviceTypeGetResponse23 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public BroadworksConnector.Ocip.Models.CPEDeviceOptionsRead22V2 CpeDeviceOptions { get; set; }
    ...
    public BroadworksConnector.Ocip.Models.AuthenticationMode22 AuthenticationMode { get; set; }
    ...
    [XmlElement(ElementName = "roamingMode", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.RoamingMode RoamingMode { get; set; }
    [XmlElement(ElementName = "supportCallingPartyCategoryInOutboundFromHeader", IsNullable = false)]
    public bool SupportCallingPartyCategoryInOutboundFromHeader { get; set; }
 }
}
