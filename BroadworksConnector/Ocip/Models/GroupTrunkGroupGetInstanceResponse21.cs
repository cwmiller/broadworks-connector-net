...
public  class GroupTrunkGroupGetInstanceResponse21 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    [XmlElement(ElementName = "totalActiveIncomingCalls", IsNullable = false)]
    public int TotalActiveIncomingCalls { get; set; }
    [XmlElement(ElementName = "totalActiveOutgoingCalls", IsNullable = false)]
    public int TotalActiveOutgoingCalls { get; set; }
    ...
    [XmlElement(ElementName = "optionsMessageResponseStatusCode", IsNullable = false)]
    public List<string> OptionsMessageResponseStatusCode { get; set; }
 }
}
