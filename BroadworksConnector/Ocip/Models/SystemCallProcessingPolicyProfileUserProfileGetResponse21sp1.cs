...
public  class SystemCallProcessingPolicyProfileUserProfileGetResponse21sp1 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    [XmlElement(ElementName = "useMediaPolicy", IsNullable = false)]
    public bool UseMediaPolicy { get; set; }
    ...
    [XmlElement(ElementName = "usePhoneListLookupPolicy", IsNullable = false)]
    public bool UsePhoneListLookupPolicy { get; set; }
