...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// 
    /// Replaced by: SystemSIPDeviceTypeFileGetResponse22V2 in AS data mode.
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:13079""}]")]
    public class SystemSIPDeviceTypeFileGetResponse22 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _remoteFileFormat;

        [XmlElement(ElementName = "remoteFileFormat", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:13079")]
        [MinLength(1)]
        [MaxLength(128)]
