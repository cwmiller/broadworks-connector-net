...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// or an ErrorResponse.
    /// <see cref="SystemPreferreredCarrierGetUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""31dec625cdd18e8228eb61ffb34ddc0e:474""}]")]
    public class SystemPreferredCarrierGetUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.SystemPreferredCarrierGetUserListResponse>
    {

        protected string _carrier;

        [XmlElement(ElementName = "carrier", IsNullable = false, Namespace = "")]
        [Group(@"31dec625cdd18e8228eb61ffb34ddc0e:474")]
        [MinLength(1)]
        [MaxLength(80)]
