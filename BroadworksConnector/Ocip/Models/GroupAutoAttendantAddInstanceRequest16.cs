...
public  class GroupAutoAttendantAddInstanceRequest16 : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    public BroadworksConnector.Ocip.Models.AutoAttendantAddMenu16 BusinessHoursMenu { get; set; }
    [XmlElement(ElementName = "afterHoursMenu", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.AutoAttendantAddMenu16 AfterHoursMenu { get; set; }
 }
}
