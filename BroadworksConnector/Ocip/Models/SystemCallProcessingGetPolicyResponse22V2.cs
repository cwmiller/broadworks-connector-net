...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// routeOverrideDomain
    /// routeOverridePrefix
    /// Replaced by: SystemCallProcessingGetPolicyResponse23 in AS data mode.
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""de4d76f01f337fe4694212ec9f771753:7282""}]")]
    public class SystemCallProcessingGetPolicyResponse22V2 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useMaxSimultaneousCalls;

        [XmlElement(ElementName = "useMaxSimultaneousCalls", IsNullable = false, Namespace = "")]
        [Group(@"de4d76f01f337fe4694212ec9f771753:7282")]
