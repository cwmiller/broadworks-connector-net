...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="SystemCallProcessingPolicyProfileCollaborateProfileGetRequest"/>
    /// <see cref="SystemCallProcessingPolicyProfileCollaborateProfileGetResponse22"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ab0042aa512abc10edb3c55e4b416b0b:22594""}]")]
    public class SystemCallProcessingPolicyProfileCollaborateProfileGetResponse : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        private bool _useCLIDPolicy;

        [XmlElement(ElementName = "useCLIDPolicy", IsNullable = false, Namespace = "")]
        [Group(@"ab0042aa512abc10edb3c55e4b416b0b:22594")]
