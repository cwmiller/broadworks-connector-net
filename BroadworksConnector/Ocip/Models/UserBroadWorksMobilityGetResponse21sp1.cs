...
public  class UserBroadWorksMobilityGetResponse21sp1 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    [XmlElement(ElementName = "profileIdentityMobileNumberAlertedTable", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.C.OCITable ProfileIdentityMobileNumberAlertedTable { get; set; }
    [XmlElement(ElementName = "mobileIdentityTable", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.C.OCITable MobileIdentityTable { get; set; }
 }
}
