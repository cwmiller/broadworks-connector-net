...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="UserBroadWorksAnywhereGetAvailableListResponse21sp1"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""f39163d0e42e05c4a1692a62f625df9f:362""}]")]
    public class UserBroadWorksAnywhereGetAvailablePortalListRequest21sp1 : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.UserBroadWorksAnywhereGetAvailablePortalListResponse21sp1>
    {
        ...
        [Group(@"f39163d0e42e05c4a1692a62f625df9f:362")]
        [MinLength(1)]
        [MaxLength(161)]
