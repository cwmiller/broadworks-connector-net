...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// 
    /// Replaced by: SystemSIPDeviceTypeAddRequest23V9.
    /// <see cref="SuccessResponse"/>
    /// <see cref="ErrorResponse"/>
    /// <see cref="macInNonRequest"/>
    /// <see cref="SystemSIPDeviceTypeAddRequest23V9"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:11710""}]")]
    public class SystemSIPDeviceTypeAddRequest22V12 : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:11710")]
        [MinLength(1)]
        [MaxLength(40)]
