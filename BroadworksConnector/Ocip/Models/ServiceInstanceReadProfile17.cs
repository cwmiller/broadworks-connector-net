...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""6337d0cfba4de1c83587203c5b0bae54:5584""}]")]
    public class ServiceInstanceReadProfile17
    {

        protected string _name;

        [XmlElement(ElementName = "name", IsNullable = false, Namespace = "")]
        [Group(@"6337d0cfba4de1c83587203c5b0bae54:5584")]
        [MinLength(1)]
        [MaxLength(30)]
        public string Name
        {
        ...
        public string TimeZoneDisplayName
        {
            ...
            set
            {
                TimeZoneDisplayNameSpecified = (value != null);
