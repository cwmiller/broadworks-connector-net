...
{
    /// <summary>
    /// Response to UserMusicOnHoldUserGetRequestRI.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""3a0309eb8d406fefc891f554ef114669:312""}]")]
    public class UserMusicOnHoldUserGetResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _enableVideo;

        [XmlElement(ElementName = "enableVideo", IsNullable = false, Namespace = "")]
        [Group(@"3a0309eb8d406fefc891f554ef114669:312")]
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldUserSourceReadRI _source;

        [XmlElement(ElementName = "source", IsNullable = false, Namespace = "")]
        [Group(@"3a0309eb8d406fefc891f554ef114669:312")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldUserSourceReadRI Source
        {
            get => _source;
            set
            {
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldUserSourceReadRI _internalSource;

        [XmlElement(ElementName = "internalSource", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"3a0309eb8d406fefc891f554ef114669:312")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldUserSourceReadRI InternalSource
        {
            get => _internalSource;
            set
            {
