...
public  class DeviceManagementFileAuthLocationGetResponse22V2 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public BroadworksConnector.Ocip.Models.DeviceManagementFileAuthenticationStatus Status { get; set; }
    ...
    [XmlElement(ElementName = "notifyFileUpload", IsNullable = false)]
    public bool NotifyFileUpload { get; set; }
 }
}
