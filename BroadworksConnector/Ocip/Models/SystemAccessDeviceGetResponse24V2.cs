...
{
    /// <summary>
    /// Response to SystemAccessDeviceGetRequest24V2
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:8638""}]")]
    public class SystemAccessDeviceGetResponse24V2 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:8638")]
        [MinLength(1)]
        [MaxLength(40)]
