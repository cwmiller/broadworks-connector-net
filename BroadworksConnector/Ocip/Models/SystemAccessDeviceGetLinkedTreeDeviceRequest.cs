...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// ErrorResponse.
    /// <see cref="SystemAccessDeviceGetLinkedTreeDeviceResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:1221""}]")]
    public class SystemAccessDeviceGetLinkedTreeDeviceRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.SystemAccessDeviceGetLinkedTreeDeviceResponse>
    {
        ...
        [Group(@"da582a1f8028404e70d260cf1f891033:1221")]
        [MinLength(1)]
        [MaxLength(40)]
