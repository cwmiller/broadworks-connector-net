...
{
    /// <summary>
    /// Response to the GroupMusicOnHoldGetInstanceRequestRI.
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:4115""}]")]
    public class GroupMusicOnHoldGetInstanceResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _serviceUserId;

        [XmlElement(ElementName = "serviceUserId", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:4115")]
        [MinLength(1)]
        [MaxLength(161)]
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceReadRI _source;

        [XmlElement(ElementName = "source", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:4115")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceReadRI Source
        {
            get => _source;
            set
            {
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceReadRI _internalSource;

        [XmlElement(ElementName = "internalSource", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:4115")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceReadRI InternalSource
        {
            get => _internalSource;
            set
            {
