...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// 
    /// Replaced by: GroupGetResponse24
    /// <see cref="GroupGetRequest22V5"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:3522""}]")]
    public class GroupGetResponse22V5 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _defaultDomain;

        [XmlElement(ElementName = "defaultDomain", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3522")]
        [MinLength(1)]
        [MaxLength(80)]
