...
public  class GroupAutoAttendantGetInstanceResponse20 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public BroadworksConnector.Ocip.Models.AutoAttendantReadMenu20 BusinessHoursMenu { get; set; }
    [XmlElement(ElementName = "afterHoursMenu", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.AutoAttendantReadMenu20 AfterHoursMenu { get; set; }
    [XmlElement(ElementName = "holidayMenu", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.AutoAttendantReadMenu20 HolidayMenu { get; set; }
