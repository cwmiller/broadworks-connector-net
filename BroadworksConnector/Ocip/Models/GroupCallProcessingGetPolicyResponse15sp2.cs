...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupCallProcessingGetPolicyRequest15sp2"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:8203""}]")]
    public class GroupCallProcessingGetPolicyResponse15sp2 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useGroupCLIDSetting;

        [XmlElement(ElementName = "useGroupCLIDSetting", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:8203")]
