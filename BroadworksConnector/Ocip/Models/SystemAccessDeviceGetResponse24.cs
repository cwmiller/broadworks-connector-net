...
{
    /// <summary>
    /// Response to SystemAccessDeviceGetRequest24
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:8027""}]")]
    public class SystemAccessDeviceGetResponse24 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:8027")]
        [MinLength(1)]
        [MaxLength(40)]
