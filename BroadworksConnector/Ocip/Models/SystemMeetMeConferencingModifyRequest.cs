...
public  class SystemMeetMeConferencingModifyRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "recordingWebAppURL", IsNullable = true)]
    ...
    [XmlElement(ElementName = "conferenceActiveTalkerRefreshIntervalSeconds", IsNullable = false)]
    public int ConferenceActiveTalkerRefreshIntervalSeconds { get; set; }
 }
}
