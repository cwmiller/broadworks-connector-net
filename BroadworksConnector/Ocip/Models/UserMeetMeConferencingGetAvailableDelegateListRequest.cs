...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="UserMeetMeConferencingGetAvailableDelegateListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""adf25df72505d1c476ebb480b6cce18d:610""}]")]
    public class UserMeetMeConferencingGetAvailableDelegateListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.UserMeetMeConferencingGetAvailableDelegateListResponse>
    {

        protected string _userId;

        [XmlElement(ElementName = "userId", IsNullable = false, Namespace = "")]
        [Group(@"adf25df72505d1c476ebb480b6cce18d:610")]
        [MinLength(1)]
        [MaxLength(161)]
