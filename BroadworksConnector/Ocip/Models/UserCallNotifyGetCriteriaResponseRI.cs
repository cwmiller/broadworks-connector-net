...
{
    /// <summary>
    /// Response to the UserCallNotifyGetCriteriaRequestRI.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ec1be3ca6e990aac87b6fcf39d5e3445:210""}]")]
    public class UserCallNotifyGetCriteriaResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Optional]
        [Group(@"ec1be3ca6e990aac87b6fcf39d5e3445:210")]
