...
public  class UserVoiceMessagingUserGetGreetingResponse18sp1 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    public string ExtendedAwayAudioFile { get; set; }
    [XmlElement(ElementName = "extendedAwayAudioMediaType", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.MediaFileType ExtendedAwayAudioMediaType { get; set; }
    [XmlElement(ElementName = "extendedAwayVideoFile", IsNullable = false)]
    public string ExtendedAwayVideoFile { get; set; }
    [XmlElement(ElementName = "extendedAwayVideoMediaType", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.MediaFileType ExtendedAwayVideoMediaType { get; set; }
