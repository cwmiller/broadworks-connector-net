...
public  class EnterpriseVirtualOnNetEnterpriseExtensionsGetUserListRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "searchCriteriaExactVirtualOnNetCallTypeName", IsNullable = false)]
    public List<BroadworksConnector.Ocip.Models.SearchCriteriaExactVirtualOnNetCallTypeName> SearchCriteriaExactVirtualOnNetCallTypeName { get; set; }
 }
}
