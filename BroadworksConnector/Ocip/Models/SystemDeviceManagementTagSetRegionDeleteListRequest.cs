...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    public class SystemDeviceManagementTagSetRegionDeleteListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest
    {
        ...
        private List<string> _regionName = new List<string>();
