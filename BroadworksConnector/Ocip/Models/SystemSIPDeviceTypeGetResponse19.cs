...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// holdAnnouncementMethod, value "useInactive" is returned in XS data mode
    ...
    /// <see cref="SystemSIPDeviceTypeGetResponse19sSp1"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ab0042aa512abc10edb3c55e4b416b0b:32972""}]")]
    public class SystemSIPDeviceTypeGetResponse19 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        private bool _isObsolete;

        [XmlElement(ElementName = "isObsolete", IsNullable = false, Namespace = "")]
        [Group(@"ab0042aa512abc10edb3c55e4b416b0b:32972")]
