...
[Serializable]
[XmlRoot(Namespace = "")]
public  class SystemVoiceMessagingGroupModifyRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "maxGreetingLengthMinutes", IsNullable = false)]
    public int MaxGreetingLengthMinutes { get; set; }
    ...
    [XmlElement(ElementName = "defaultExternalRoutingAddress", IsNullable = true)]
