...
{
    /// <summary>
    /// Response to SystemPolicyGetDefaultRequestRI.
    ...
    /// serviceProviderAdminPasswordRulesAccess, value "Full" is returned in XS mode
    /// groupAdminPasswordRulesAccess, value "Full" is returned in XS mode
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""da582a1f8028404e70d260cf1f891033:14870""}]")]
    public class SystemPolicyGetDefaultResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Group(@"da582a1f8028404e70d260cf1f891033:14870")]
        ...
        public BroadWorksConnector.Ocip.Models.GroupAdminPasswordRulesAccess GroupAdminPasswordRulesAccess
        {
            ...
            set
            {
                GroupAdminPasswordRulesAccessSpecified = true;
        ...
        public BroadWorksConnector.Ocip.Models.ServiceProviderAdminPasswordRulesAccess ServiceProviderAdminPasswordRulesAccess
        {
            ...
            set
            {
                ServiceProviderAdminPasswordRulesAccessSpecified = true;
