...
[Serializable]
[XmlRoot(Namespace = "")]
public  class DeviceManagementDeviceTypeOptions 
{
    [XmlElement(ElementName = "deviceAccessProtocol", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.DeviceAccessProtocol DeviceAccessProtocol { get; set; }
    ...
    public BroadworksConnector.Ocip.Models.DeviceManagementUserNamePassword AccessDeviceCredentials { get; set; }
