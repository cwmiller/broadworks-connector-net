...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupMusicOnHoldGetInstanceRequest22"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:3744""}]")]
    public class GroupMusicOnHoldGetInstanceResponse22 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _serviceUserId;

        [XmlElement(ElementName = "serviceUserId", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3744")]
        [MinLength(1)]
        [MaxLength(161)]
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead22 _source;

        [XmlElement(ElementName = "source", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3744")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead22 Source
        {
            get => _source;
            set
            {
        ...
        protected BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead22 _internalSource;

        [XmlElement(ElementName = "internalSource", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:3744")]
        public BroadWorksConnector.Ocip.Models.MusicOnHoldSourceRead22 InternalSource
        {
            get => _internalSource;
            set
            {
