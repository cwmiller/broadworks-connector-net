...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// or an ErorResponse.
    /// <see cref="GroupNetworkClassOfServiceGetAssignedUserListResponse21"/>
    /// <see cref="ErorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""f3a93cf15de4abd7903673e44ee3e07b:6546""}]")]
    public class GroupNetworkClassOfServiceGetAssignedUserListRequest21 : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupNetworkClassOfServiceGetAssignedUserListResponse21>
    {

        private string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"f3a93cf15de4abd7903673e44ee3e07b:6546")]
        [MinLength(1)]
        [MaxLength(30)]
