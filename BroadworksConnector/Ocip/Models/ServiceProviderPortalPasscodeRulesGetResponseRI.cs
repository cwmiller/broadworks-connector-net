...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// enableDefaultPasscode, value "false" is returned in XS data mode
    /// defaultPasscode
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""e19a9072c2dad499e9f28837da5768db:5531""}]")]
    public class ServiceProviderPortalPasscodeRulesGetResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _disallowRepeatedDigits;

        [XmlElement(ElementName = "disallowRepeatedDigits", IsNullable = false, Namespace = "")]
        [Group(@"e19a9072c2dad499e9f28837da5768db:5531")]
        ...
        public string DefaultPasscode
        {
            ...
            set
            {
                DefaultPasscodeSpecified = (value != null);
