...
public  class GroupDnGetAssignmentPagedSortedListRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    public List<BroadworksConnector.Ocip.Models.SortOrderGroupDnGetAssignmentPagedSortedList> SortOrder { get; set; }
    ...
    [XmlElement(ElementName = "searchCriteriaExactDnAvailability", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.SearchCriteriaExactDnAvailability SearchCriteriaExactDnAvailability { get; set; }
    ...
    public List<BroadworksConnector.Ocip.Models.SearchCriteriaExactUserType> SearchCriteriaExactUserType { get; set; }
