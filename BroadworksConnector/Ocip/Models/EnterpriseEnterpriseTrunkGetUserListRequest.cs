...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""090e91b2d78e873f5d76a2f16af08d3a:384""}]")]
    public class EnterpriseEnterpriseTrunkGetUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.EnterpriseEnterpriseTrunkGetUserListResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"090e91b2d78e873f5d76a2f16af08d3a:384")]
        [MinLength(1)]
        [MaxLength(30)]
        ...
        public List<BroadWorksConnector.Ocip.Models.SearchCriteriaAlternateTrunkIdentity> SearchCriteriaAlternateTrunkIdentity
        {
            ...
            set
            {
                SearchCriteriaAlternateTrunkIdentitySpecified = (value != null);
        ...
        public List<BroadWorksConnector.Ocip.Models.SearchCriteriaAlternateTrunkIdentityDomain> SearchCriteriaAlternateTrunkIdentityDomain
        {
            ...
            set
            {
                SearchCriteriaAlternateTrunkIdentityDomainSpecified = (value != null);
        ...
        protected List<BroadWorksConnector.Ocip.Models.SearchCriteriaExactUserRouteListAssigned> _searchCriteriaExactUserRouteListAssigned = new List<BroadWorksConnector.Ocip.Models.SearchCriteriaExactUserRouteListAssigned>();
        ...
        public List<BroadWorksConnector.Ocip.Models.SearchCriteriaExactUserRouteListAssigned> SearchCriteriaExactUserRouteListAssigned
        {
            ...
            set
            {
                SearchCriteriaExactUserRouteListAssignedSpecified = (value != null);
                _searchCriteriaExactUserRouteListAssigned = value;
            }
        }

        [XmlIgnore]
        protected bool SearchCriteriaExactUserRouteListAssignedSpecified { get; set; }
