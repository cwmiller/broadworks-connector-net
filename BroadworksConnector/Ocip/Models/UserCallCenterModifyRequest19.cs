...
public  class UserCallCenterModifyRequest19 : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "callCenterAgentSettings", IsNullable = false)]
    public List<BroadworksConnector.Ocip.Models.CallCenterAgentSettings> CallCenterAgentSettings { get; set; }
 }
}
