...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// 2. repositoryUrl may be set to "DEVICE_CONFIGURATION_FILE_REPOSITORY_MISSING", if there is no file
    /// repository defined.
    /// 
    /// Replaced by: SystemSIPDeviceTypeFileGetResponse20 in AS data mode
    /// <see cref="SystemSIPDeviceTypeFileGetRequest19"/>
    /// <see cref="SystemSIPDeviceTypeFileGetResponse20"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ab0042aa512abc10edb3c55e4b416b0b:31782""}]")]
    public class SystemSIPDeviceTypeFileGetResponse19 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
