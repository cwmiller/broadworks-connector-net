...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="SystemCallProcessingPolicyProfileTrunkGroupPilotProfileGetRequest"/>
    /// <see cref="SystemCallProcessingPolicyProfileTrunkGroupPilotProfileGetResponse22"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""ab0042aa512abc10edb3c55e4b416b0b:38264""}]")]
    public class SystemCallProcessingPolicyProfileTrunkGroupPilotProfileGetResponse : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        private bool _useCLIDPolicy;

        [XmlElement(ElementName = "useCLIDPolicy", IsNullable = false, Namespace = "")]
        [Group(@"ab0042aa512abc10edb3c55e4b416b0b:38264")]
