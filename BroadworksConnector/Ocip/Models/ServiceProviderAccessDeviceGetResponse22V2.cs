...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="ServiceProviderAccessDeviceGetRequest22V2"/>
    /// <see cref="ServiceProviderAccessDeviceGetResponse24"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""240b50f54d060859e5e275082fdf49f9:5523""}]")]
    public class ServiceProviderAccessDeviceGetResponse22V2 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected string _deviceType;

        [XmlElement(ElementName = "deviceType", IsNullable = false, Namespace = "")]
        [Group(@"240b50f54d060859e5e275082fdf49f9:5523")]
        [MinLength(1)]
        [MaxLength(40)]
