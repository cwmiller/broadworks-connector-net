...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// or an ErorResponse.
    /// <see cref="GroupNetworkClassOfServiceGetAssignedUserListResponse"/>
    /// <see cref="ErorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""de4d76f01f337fe4694212ec9f771753:3361""}]")]
    public class GroupNetworkClassOfServiceGetAssignedUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupNetworkClassOfServiceGetAssignedUserListResponse>
    {

        private string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"de4d76f01f337fe4694212ec9f771753:3361")]
        [MinLength(1)]
        [MaxLength(30)]
