...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""146ca46a7097f08aed7a73ab65f17df8:472""}]")]
    public class GroupFindMeFollowMeModifyAlertingGroupSelectiveCriteriaRequestRI : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.C.SuccessResponse>
    {

        protected string _serviceUserId;

        [XmlElement(ElementName = "serviceUserId", IsNullable = false, Namespace = "")]
        [Group(@"146ca46a7097f08aed7a73ab65f17df8:472")]
        [MinLength(1)]
        [MaxLength(161)]
        ...
        protected BroadWorksConnector.Ocip.Models.CriteriaFromDnModify23 _fromDnCriteria;

        [XmlElement(ElementName = "fromDnCriteria", IsNullable = false, Namespace = "")]
        [Optional]
        [Group(@"146ca46a7097f08aed7a73ab65f17df8:472")]
        public BroadWorksConnector.Ocip.Models.CriteriaFromDnModify23 FromDnCriteria
        {
            get => _fromDnCriteria;
            set
            {
