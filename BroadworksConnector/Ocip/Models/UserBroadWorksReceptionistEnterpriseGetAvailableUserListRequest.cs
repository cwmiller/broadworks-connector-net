...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="UserBroadWorksReceptionistEnterpriseGetAvailableUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""44477d346d2631b033071e12af214ac8:133""}]")]
    public class UserBroadWorksReceptionistEnterpriseGetAvailableUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.UserBroadWorksReceptionistEnterpriseGetAvailableUserListResponse>
    {

        protected string _userId;

        [XmlElement(ElementName = "userId", IsNullable = false, Namespace = "")]
        [Group(@"44477d346d2631b033071e12af214ac8:133")]
        [MinLength(1)]
        [MaxLength(161)]
