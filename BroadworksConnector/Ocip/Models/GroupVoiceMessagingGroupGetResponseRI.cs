...
{
    /// <summary>
    /// Response to GroupVoiceMessagingGroupGetRequestRI.
    /// Contains the group's voice messaging settings.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""1fea1222b6a78aa7b98fd5c41bdae113:133""}]")]
    public class GroupVoiceMessagingGroupGetResponseRI : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {
        ...
        [Group(@"1fea1222b6a78aa7b98fd5c41bdae113:133")]
