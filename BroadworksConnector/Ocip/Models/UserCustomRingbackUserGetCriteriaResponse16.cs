...
public  class UserCustomRingbackUserGetCriteriaResponse16 : BroadworksConnector.Ocip.Models.C.OCIDataResponse
{
    ...
    [XmlElement(ElementName = "callWaitingAudioMediaType", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.MediaFileType CallWaitingAudioMediaType { get; set; }
    ...
    [XmlElement(ElementName = "callWaitingVideoMediaType", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.MediaFileType CallWaitingVideoMediaType { get; set; }
