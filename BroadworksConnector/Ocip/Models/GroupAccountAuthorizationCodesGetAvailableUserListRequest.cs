...
namespace BroadWorksConnector.Ocip.Models
{
    ...
    /// <see cref="GroupAccountAuthorizationCodesGetAvailableUserListResponse"/>
    /// <see cref="ErrorResponse"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""fcf43b3a58ff66521262b4426bab8748:88""}]")]
    public class GroupAccountAuthorizationCodesGetAvailableUserListRequest : BroadWorksConnector.Ocip.Models.C.OCIRequest<BroadWorksConnector.Ocip.Models.GroupAccountAuthorizationCodesGetAvailableUserListResponse>
    {

        protected string _serviceProviderId;

        [XmlElement(ElementName = "serviceProviderId", IsNullable = false, Namespace = "")]
        [Group(@"fcf43b3a58ff66521262b4426bab8748:88")]
        [MinLength(1)]
        [MaxLength(30)]
