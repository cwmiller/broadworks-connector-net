...
{
    /// <summary>
    /// The call type criteria added with the option for selecting internal and external callers, used within an add/get request.
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""6337d0cfba4de1c83587203c5b0bae54:5400""}]")]
    public class SelectiveCallRejectionCriteriaCallTypeRI
    {
        ...
        [Group(@"6337d0cfba4de1c83587203c5b0bae54:5400")]
        ...
        public bool IncludeInternalCallers
        {
            ...
            set
            {
                IncludeInternalCallersSpecified = true;
        ...
        public bool IncludeExternalCallers
        {
            ...
            set
            {
                IncludeExternalCallersSpecified = true;
