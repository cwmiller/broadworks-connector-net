...
public  class UserVoiceMessagingUserModifyRequest : BroadworksConnector.Ocip.Models.C.OCIRequest
{
    ...
    [XmlElement(ElementName = "userMessagingAliasList", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.VoiceMessagingAliasListModify UserMessagingAliasList { get; set; }
 }
}
