...
public  class MusicOnHoldSourceRead16 
{
    ...
    public BroadworksConnector.Ocip.Models.MusicOnHoldSourceRead16CustomSource CustomSource { get; set; }
    [XmlElement(ElementName = "externalSource", IsNullable = false)]
    public BroadworksConnector.Ocip.Models.MusicOnHoldSourceRead16ExternalSource ExternalSource { get; set; }
 }
}
