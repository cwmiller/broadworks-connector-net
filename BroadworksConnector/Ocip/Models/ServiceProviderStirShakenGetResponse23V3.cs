...
{
    /// <summary>
    /// Response to the ServiceProviderStirShakenGetRequest23V3.
    /// Replaced by ServiceProviderStirShakenGetResponse23V4.
    /// <see cref="ServiceProviderStirShakenGetRequest23V3"/>
    /// <see cref="ServiceProviderStirShakenGetResponse23V4"/>
    /// </summary>
    [Serializable]
    [XmlRoot(Namespace = "")]

    [Groups(@"[{""__type"":""Sequence:#BroadWorksConnector.Ocip.Validation"",""id"":""d8f04177e438f303b41c211e518706bf:22293""}]")]
    public class ServiceProviderStirShakenGetResponse23V3 : BroadWorksConnector.Ocip.Models.C.OCIDataResponse
    {

        protected bool _useParentLevelSettings;

        [XmlElement(ElementName = "useParentLevelSettings", IsNullable = false, Namespace = "")]
        [Group(@"d8f04177e438f303b41c211e518706bf:22293")]
